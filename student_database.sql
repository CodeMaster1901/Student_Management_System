...
(1, 'PES2UG21CS012', 'STUDENT INSERTED', '2023-11-16 19:19:56'),
(2, 'PES2UG21CS012', 'STUDENT UPDATED', '2023-11-16 19:20:31'),
(3, 'PES2UG21CS012', 'STUDENT DELETED', '2021-11-16 19:21:23');
...
(1, 'anees', 'anees@gmail.com', 'pbkdf2:sha256:150000$1CSLss89$ef995dfc48121768b2070bfbe7a568871cd56fac85ac7c95a1e645c8806146e9');
...
DELIMITER //
CREATE FUNCTION GetTotalStudentCount() RETURNS INT
DETERMINISTIC
BEGIN
    DECLARE total_count INT;

    -- Use a nested join and aggregate query to get the total count
    SELECT COUNT(*) INTO total_count
    FROM student s
    JOIN department d ON s.branch = d.branch;
...
--
-- Procedure to find department-wise count of students
--

DELIMITER //

-- Procedure to get department-wise student count
CREATE PROCEDURE GetDepartmentWiseStudentCount()
BEGIN
    -- Department-wise student count
    SELECT d.branch AS 'Department', COUNT(*) AS 'Count'
    FROM student s
    JOIN department d ON s.branch = d.branch
    GROUP BY d.branch;
END //
